-- Add is_closed column for "permanently closed" marking
alter table shops add column is_closed boolean default false;

-- Update shops_within_radius function to include is_closed
...
as $$
  select
    ...
    s.google_rating, s.google_review_count, s.is_active, s.is_closed,
